...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        Server UbuntuServer = new Server("server", "https://www.awesominki.shop/", "for prod server", Collections.emptyList(), Collections.emptyList());
        return new Docket(DocumentationType.OAS_30)
                .servers(serverLocal,UbuntuServer)
    ...
    private ApiInfo apiInfo() {
        String description = "Cindy";
        return new ApiInfoBuilder()
                .title("Cindy Rest API 명세서")
